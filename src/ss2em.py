...
""" Convert a static web site to and enbedded system (ss2em.py)

    This script can be used to encode an static web site (for 
    example one generated by Hugo (https://gohugo.io/) to an 
    embedded site to be hosted in a microcontroller.
